...
int main()
{
    int historia;
    char codigo;
    cout << "Ingrese el número de historia del paciente: ";
    cin >> historia;
    cout << "Ingrese el tipo de consulta: A, D, F, M o T: ";
    cin >> codigo;
    cout << "----" << endl;
    ...
    case 'A':
    case 'a':
        cout << "Paciente: " << historia << " - Codigo: " << codigo << " - Importe a pagar: $200" << endl;
        break;

    case 'D':
    case 'd':
        cout << "Paciente: " << historia << " - Codigo: " << codigo << " - Importe a pagar: $400" << endl;
        break;

    case 'F':
    case 'f':
        cout << "Paciente: " << historia << " - Codigo: " << codigo << " - Importe a pagar: $600" << endl;
        break;
    ...
    case 'T':
    case 't':
        cout << "Paciente: " << historia << " - Codigo: " << codigo << " - Importe a pagar: $1500" << endl;
        break;
