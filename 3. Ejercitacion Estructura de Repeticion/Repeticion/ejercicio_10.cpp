...
/*
    ...
    Por cada partido disputado por un equipo se dispone de la siguiente infromación
    a) Nombre del equipo,
...
int main()
{
    ...
    for (int i = 1; i <= k; i++)
    {
        ...
        for (int j = 1; j <= k; j++)
        {
            ...
            char resultado;
            cout << "Ingrese el resultado del partido del equipo " << i << " contra el equipo " << j << endl;
