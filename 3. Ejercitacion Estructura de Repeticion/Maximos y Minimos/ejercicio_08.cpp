...
int main()
{
    int estudiosPrimCompletos = 0;
    int analfabetos = 0;
    int porcentajeAnalfabetos = 0;
    int cantPersonasEncuestadas = 0;
    int cantViviendasEncuestadas = 0;
    int mayorCantIntegrantes = 0;
    string domicilioMayorCantIntegrantes = "";
    int sumaEdades = 0;
    int promEdades = 0;
    int mayorPromEdades = 0;
    int cantSecundariosIncompletos = 0;
    int cantTerciariosCompletosFemeninos = 0;
    int cantPersonasEncuestadasFemeninos = 0;
    int porcentajeTerciariosCompletosFemeninos = 0;
