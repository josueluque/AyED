...
int main2()
{
    int añoDeNacimiento, añoActual, edadResultante;
    cout << "Ingrese su año de nacimiento: ";
    cin >> añoDeNacimiento;
    cout << "Ingrese el año actual: ";
    cin >> añoActual;

    edadResultante = añoActual - añoDeNacimiento;
    cout << "Su edad puede ser: " << edadResultante << " o " << edadResultante - 1 << endl; // Se hace ese resta - 1 ya que puede ser que la persona cumpla despues de el dia actual
    return 0;
}

// DESAFIO: Hacer que tenga en cuenta los meses con la formula que dejó en el pizarron
